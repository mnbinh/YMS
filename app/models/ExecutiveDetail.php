...
class ExecutiveDetail extends \Eloquent {
	protected $fillable = [];
    protected $table = 'executive_details';
    public function schoolProrogue()
    {
        return $this->belongsTo('SchoolProrogue' , 'school_prorogues_id' , 'id');
    }
    ...
    public function scopeSchoolProrogueId($query , $prorogue_id)
    {
        return $query->where('school_prorogue_id' , '=' , $prorogue_id);
    }
}