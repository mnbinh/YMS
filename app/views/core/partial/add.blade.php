  ...
  {{Form::open(array('url'=> URL::route('store.appoint', array('id' => $list_id)) , 'class' => 'form-horizontal' , 'id' => 'addForm'))}}
             <div class="step-content">
                 ...
                 <div class="step-pane" data-step="2">
                      ...
                      <div class="form-group" style="margin: 10px;">
                                                                      {{--<label for="exampleInputEmail1">Mã Chi Đoàn</label>--}}
                                                                      {{--<input type="text" class="form-control" name="union_id" placeholder="Ví dụ: KH11Y1A1">--}}
                            {{Form::label('explain' , 'Thành tích' , array('class'=>'col-xs-3 control-label'))}}
                              <div class="col-xs-9">
                            {{Form::textarea('explain'  , null, array('class' =>'form-control text-area'))}}
                        </div>
                      </div>
