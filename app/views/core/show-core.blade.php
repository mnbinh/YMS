...
@section('content')
 <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">Lực Lượng Nòng Cốt</a></li>
...
<h3 class="box-title">Danh Sách Đề Cử Lực Lượng Nòng Cốt</h3>
</div>
<div class="box-body">
      ...
      <dt class="text-muted"><b>Năm Học:</b></dt>
        ...
        <dt class="text-muted"><b>Học Kỳ:</b></dt>
         ...
         <dt class="text-muted"><b>Trạng Thái:</b></dt>
          <dd>
          @if($core->end_date->gte(\Carbon\Carbon::now()))
          <div class="label bg-red">Nộp Danh Sách</div>
          @elseif($core->expired_date->gte(\Carbon\Carbon::now()))
...
$(document).ready(function(){
 ...
 var url = '{{URL::route('ajax.detail.list.appoint')}}' +'?core_id={{$core->id}}' +'&list_id='+ data.value ;
              ...
              checkbox.hide().parent().append('<i class="fa fa-refresh fa-spin"></i>');
                 ...
                 var url ;
                  ...
                  if($(this).prop('checked')){
                   url = "{{URL::route('confirm.core.member')}}";

                   } else{
                  url = "{{URL::route('unconfirm.core.member')}}";
